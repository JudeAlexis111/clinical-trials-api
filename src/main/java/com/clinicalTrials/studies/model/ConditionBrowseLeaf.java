...
public class ConditionBrowseLeaf {
  ...
  @JsonProperty("ConditionBrowseLeafId")
  public String conditionBrowseLeafId;

  @JsonProperty("ConditionBrowseLeafName")
  public String conditionBrowseLeafName;

  @JsonProperty("ConditionBrowseLeafAsFound")
  public String conditionBrowseLeafAsFound;

  @JsonProperty("ConditionBrowseLeafRelevance")
